...
class CanalBaseModel(BaseModel):
    ...
    canal_id: str | None = Field(default=None, description='渠段编号（主键；命名形如 1 / 1-1 / 1-1-1）')
    canal_name: str | None = Field(default=None, description='渠段名称')
    parent_id: str | None = Field(default=None, description='父渠段编号')
    level: str | None = Field(default=None, description='1 干 / 2 支 / 3 斗 / 4 农')
    length: float | None = Field(default=None, description='渠段长度 (m)')
    design_flow: float | None = Field(default=None, description='设计流量 (m³/s)')
    design_depth: float | None = Field(default=None, description='设计水深 (m)')
    top_width: float | None = Field(default=None, description='设计渠顶宽 (m)')
    bottom_width: float | None = Field(default=None, description='设计渠底宽 (m)')
    slope: float | None = Field(default=None, description='设计纵坡')
    ...
    gate_height: float | None = Field(default=None, description='闸门高度 (m)')
    gate_width: float | None = Field(default=None, description='闸门宽度 (m)')
    min_gate_opening: float | None = Field(default=None, description='闸门最小开度 (m)')
    max_gate_opening: float | None = Field(default=None, description='闸门最大开度 (m)')
