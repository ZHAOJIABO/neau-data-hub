...
class IrrigationZoneService:
                ...
                data = cls._normalize_payload(
                    {
                        ...
                        'iwue': cls._to_float(row.get('iwue'), 0.0),
                        'water_productivity_kg_m3': cls._to_float(row.get('water_productivity_kg_m3'), 0.0),
                        'benefit_yuan_per_m3': cls._to_float(row.get('benefit_yuan_per_m3'), 0.0),
                        'irrigation_reliability': cls._to_float(row.get('irrigation_reliability'), 0.0),
                        'field_efficiency': cls._to_float(row.get('field_efficiency'), 0.0),
                        'surface_water_utilization': cls._to_float(row.get('surface_water_utilization'), 0.0),
                        'groundwater_utilization': cls._to_float(row.get('groundwater_utilization'), 0.0),
                        'groundwater_dependency': cls._to_float(row.get('groundwater_dependency'), 0.0),
    ...
    def _record_to_api(record: Any) -> dict[str, Any]:
        return {
            ...
            'iwue': float(record.iwue or 0.0),
            'water_productivity_kg_m3': float(record.water_productivity_kg_m3 or 0.0),
            'benefit_yuan_per_m3': float(record.benefit_yuan_per_m3 or 0.0),
            'irrigation_reliability': float(record.irrigation_reliability or 0.0),
            'field_efficiency': float(record.field_efficiency or 0.0),
            'surface_water_utilization': float(record.surface_water_utilization or 0.0),
            'groundwater_utilization': float(record.groundwater_utilization or 0.0),
            'groundwater_dependency': float(record.groundwater_dependency or 0.0),
